...
#include "uArmPin.h"
	...
	#define SDA_SET		PORTC |= 0x08
	#define SDA_CLEAR	PORTC &= 0xF7
	#define SCL_SET		PORTC |= 0x04	
	#define SCL_CLEAR	PORTC &= 0xFB

	#define SDA_INPUT	DDRC &= 0xF7
	#define SDA_OUTPUT	DDRC |= 0x08

	#define SCL_INPUT	DDRC &= 0xFB
	#define SCL_OUTPUT	DDRC |= 0x04

	#define SDA_READ	PINC & 0x08
