...
#elif defined(SWIFT)
   extern uArmLed ledRed;
   extern uArmLed ledGreen;
   extern uArmLed ledBlue;

   extern uArmButton buttonState;
#endif   
...
/*!
   ...
   \param speed: 
   			...
   			[100~60000]: mm/min, will do interpolation to control the speed and block process util move done
 ...
 */
unsigned char moveTo(double x, double y, double z, double speed = 6000);
 ...
 */
unsigned char setServoAngle(unsigned char servoNumber, double angle, double speed = 6000);
